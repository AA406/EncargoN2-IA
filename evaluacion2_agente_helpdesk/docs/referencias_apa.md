...
LangChain. (2025). *LangChain Python documentation*. https://python.langchain.com/
...
Duoc UC. (2025). *Evaluación Parcial N°2: Desarrollo de un Agente Funcional. Instrucciones y pauta de evaluación*. Subdirección de Diseño Instruccional.
